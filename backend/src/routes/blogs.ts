...
router.post('/:id/like', toggleLikeBlog as any);
router.post('/:id/bookmark', toggleBookmarkBlog as any);
router.post('/interactions', getUserBlogInteractions as any);
