      ...
      if (notificationService && applicantId) {
        if (status === 'accepted') {
          await notificationService.createNotification({
            ...
            message: `Congratulations! Your application for "${job.title}" at ${job.company || 'the company'} has been accepted.`,
            richContent: {
              image: undefined,
              avatar: undefined,
          ...
          await notificationService.createNotification({
            ...
            message: `Your application for "${job.title}" at ${job.company || 'the company'} was not selected for this position.`,
            richContent: {
              image: undefined,
              avatar: undefined,
          ...
          try {
            ...
            if (notificationService && applicantId) {
              await notificationService.createNotification({
                ...
                message: `A contract has been created for your position as "${job.title}" at ${job.company || 'the company'}.`,
                richContent: {
                  image: undefined,
                  avatar: undefined,
